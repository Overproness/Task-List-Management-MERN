...
const ACHIEVEMENTS = [
  ...
  },
  {
    id: "speed_demon",
    name: "Speed Demon",
    desc: "Complete a task within 1 minute of creating it",
    xp: 30,
    unlocked: false,
  },
  {
  ...
  },
  {
    id: "perfectionist",
    name: "Perfectionist",
    desc: "Complete all tasks in a single session",
    xp: 75,
    unlocked: false,
  },
];
...
const LEVELS = [
  {
    ...
    xpRequired: 0,
    name: "Beginner",
    reward: "Welcome to the journey",
  },
  {
    level: 2,
    xpRequired: 50,
    name: "Novice",
    reward: "Immersive Mode Unlocked!",
  },
  {
    level: 3,
    xpRequired: 150,
  ...
  { level: 4, xpRequired: 300, name: "Adept", reward: "Advanced animations" },
  {
    ...
    xpRequired: 500,
    name: "Expert",
    reward: "Particle effects unlocked",
  },
  {
    level: 6,
    xpRequired: 800,
